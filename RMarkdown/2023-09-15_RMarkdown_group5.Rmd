...
OurData contains 834 rows (participants) and 34 columns (variable). The columns types are character (9 values), factor (2 values), logical (12) values and numeric (11 values). 
...
### Number of participants in `C` and `T` groups for each of enrollment center.
